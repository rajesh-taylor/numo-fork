...
import io.refueler.merchant.feature.autowithdraw.AutoWithdrawProgressListener
...
class ModernPOSActivity : AppCompatActivity(), AutoWithdrawProgressListener {
    ...
    private fun initBtcMapBanner() {
        ...
        btcmapBanner?.findViewById<android.view.View>(R.id.btn_learn_more)?.setOnClickListener {
            hideBtcMapBanner()
            startActivity(Intent(this, io.refueler.merchant.feature.btcmap.BtcMapExplainerActivity::class.java))
        }
    }
     ...
     * [io.refueler.merchant.ui.theme.ThemeManager].
     */
    private fun setupWindowSettings() {
        ...
        val bgColor = io.refueler.merchant.ui.theme.ThemeManager.resolveBackgroundColor(this)
