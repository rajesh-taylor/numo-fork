...
import io.refueler.merchant.util.createProgressDialog
...
import io.refueler.merchant.ui.components.EmptyStateHelper
...
class PaymentsHistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.insightsButton.setOnClickListener {
            startActivity(Intent(this, io.refueler.merchant.feature.insights.InsightsActivity::class.java))
        }
    ...
    private fun loadBalance() {
        if (CashuWalletManager.walletState.value == io.refueler.merchant.core.cashu.WalletState.LOADING) {
    ...
    private fun checkAndFinalizeSwap(entry: PaymentHistoryEntry) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val success = io.refueler.merchant.payment.SwapToLightningMintManager.tryFinalizePendingSwap(
            ...
            withContext(Dispatchers.Main) {
                ...
                if (success) {
                    ...
                    val intent = Intent(this@PaymentsHistoryActivity, io.refueler.merchant.PaymentReceivedActivity::class.java).apply {
                        putExtra(io.refueler.merchant.PaymentReceivedActivity.EXTRA_TOKEN, "")
                        putExtra(io.refueler.merchant.PaymentReceivedActivity.EXTRA_AMOUNT, entry.amount)
                    }
