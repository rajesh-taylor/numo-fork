...
class TransactionDetailActivity : AppCompatActivity() {
    ...
    private fun setupViews() {
        val topBar = findViewById<io.refueler.merchant.ui.components.NumoTopBar>(R.id.top_bar)
    ...
    private fun displayItemsAndTotals() {
        ...
        val enteredCurrency = entry.getEntryUnit() ?: io.refueler.merchant.core.util.CurrencyManager.getInstance(this).getCurrentCurrency()
    ...
    private fun printReceipt() {
        ...
        val basket = CheckoutBasket.fromJson(basketJsonToUse)
        val receiptPrinter = io.refueler.merchant.core.util.ReceiptPrinter(this)
        
        val txId = entry.token.takeIf { it.isNotEmpty() } ?: lightningInvoice
        val enteredCurrency = entry.getEntryUnit() ?: io.refueler.merchant.core.util.CurrencyManager.getInstance(this).getCurrentCurrency()

        val receiptData = io.refueler.merchant.core.util.ReceiptPrinter.ReceiptData(
            basket = basket,
