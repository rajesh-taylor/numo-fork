...
import io.refueler.merchant.util.setSoftInputModeResize
...
import io.refueler.merchant.feature.baskets.SavedBasketsActivity
import io.refueler.merchant.feature.baskets.BasketNamesManager
import io.refueler.merchant.feature.items.adapters.SelectionBasketAdapter
import io.refueler.merchant.feature.items.CsvImportHelper
import io.refueler.merchant.feature.items.adapters.SelectionItemsAdapter
import io.refueler.merchant.feature.items.handlers.BasketUIHandler
import io.refueler.merchant.feature.items.handlers.CheckoutHandler
import io.refueler.merchant.feature.items.handlers.ItemSearchHandler
import io.refueler.merchant.feature.items.handlers.SelectionAnimationHandler
...
class ItemSelectionActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        checkoutButton.setOnClickListener {
            if (!io.refueler.merchant.core.util.NetworkUtils.isNetworkAvailable(this)) {
