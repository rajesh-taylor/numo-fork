...
import io.refueler.merchant.feature.settings.WithdrawLightningActivity
...
import io.refueler.merchant.ui.components.MintSelectionBottomSheet
...
class AutoWithdrawSettingsActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        findViewById<io.refueler.merchant.ui.components.NumoTopBar>(R.id.top_bar).onNavClick {
    ...
    private fun fetchMinThreshold(address: String) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            val details = io.refueler.merchant.core.util.LnUrlClient.fetchLnUrlDetails(address)
