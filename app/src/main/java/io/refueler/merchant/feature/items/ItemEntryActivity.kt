...
import io.refueler.merchant.feature.items.handlers.*
...
class ItemEntryActivity : AppCompatActivity() {
    ...
    private fun setupEditMode() {
        findViewById<io.refueler.merchant.ui.components.NumoTopBar>(R.id.top_bar).setTitle(getString(R.string.item_entry_title_edit))
