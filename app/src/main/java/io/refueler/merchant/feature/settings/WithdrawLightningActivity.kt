...
import io.refueler.merchant.ui.components.WithdrawAddressCard
import io.refueler.merchant.ui.components.WithdrawInvoiceCard
...
class WithdrawLightningActivity : AppCompatActivity() {
    ...
    // Views
    private lateinit var topBar: io.refueler.merchant.ui.components.NumoTopBar
    ...
    private fun createCashuToken(amountSats: Long) {
        ...
        lifecycleScope.launch {
            try {
                ...
                val autoWithdrawManager = io.refueler.merchant.feature.autowithdraw.AutoWithdrawManager.getInstance(this@WithdrawLightningActivity)
                autoWithdrawManager.addManualWithdrawalEntry(
                    ...
                    status = io.refueler.merchant.feature.autowithdraw.WithdrawHistoryEntry.STATUS_COMPLETED,
                    quoteId = null,
                    errorMessage = null,
                    token = tokenString
                )
