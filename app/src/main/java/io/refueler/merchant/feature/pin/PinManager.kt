...
class PinManager private constructor(private val context: Context) {
    ...
    private val prefs: SharedPreferences = run {
        val enc = io.refueler.merchant.core.prefs.EncryptedPreferenceStore.open(
            context, PIN_ENC_NAME, PIN_KEY_ALIAS
        )
    ...
    companion object {
        ...
        private const val PIN_ENC_NAME  = "pin_prefs_enc"
        private const val PIN_KEY_ALIAS = "refueler_pin_key"
