 ...
 *
 * Implementations:
 * - [io.refueler.merchant.core.payment.impl.LocalPaymentService] – wraps existing CDK flow
 * - [io.refueler.merchant.core.payment.impl.BTCPayPaymentService] – BTCPay Greenfield API + BTCNutServer
 */
