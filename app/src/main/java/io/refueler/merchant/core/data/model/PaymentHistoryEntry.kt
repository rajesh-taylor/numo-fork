...
data class PaymentHistoryEntry(
    ...
    fun getTipDisplayString(): String {
        return if (tipAmountSats > 0) {
            io.refueler.merchant.core.model.Amount(tipAmountSats, io.refueler.merchant.core.model.Amount.Currency.BTC).toString()
        } else {
            ""
        }
    }
     ...
     */
    fun getCheckoutBasket(): io.refueler.merchant.core.model.CheckoutBasket? {
        return io.refueler.merchant.core.model.CheckoutBasket.fromJson(checkoutBasketJson)
    }
